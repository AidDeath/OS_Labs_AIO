...
BOOL km_OnCreate(HWND hWnd, LPCREATESTRUCT lpszCreateStruct)
{
	...
	g_hBtn1Up = CreateWindow(TEXT("button"), TEXT(">"), WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, rc.left + 35, rc.top + 150, 25, 25, hWnd, (HMENU)IDC_BTN1UP, (HINSTANCE)GetWindowLongPtr(hWnd, GWLP_HINSTANCE), NULL);
	g_hBtn1Down = CreateWindow(TEXT("button"), TEXT("<"), WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, rc.left + 10, rc.top + 150, 25, 25, hWnd, (HMENU)IDC_BTN1DOWN, (HINSTANCE)GetWindowLongPtr(hWnd, GWLP_HINSTANCE), NULL);
	g_hBtn2Up = CreateWindow(TEXT("button"), TEXT(">"), WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, rc.left + 195, rc.top + 150, 25, 25, hWnd, (HMENU)IDC_BTN2UP, (HINSTANCE)GetWindowLongPtr(hWnd, GWLP_HINSTANCE), NULL);
	g_hBtn2Down = CreateWindow(TEXT("button"), TEXT("<"), WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, rc.left + 170, rc.top + 150, 25, 25, hWnd, (HMENU)IDC_BTN2DOWN, (HINSTANCE)GetWindowLongPtr(hWnd, GWLP_HINSTANCE), NULL);
	g_hBtn3Up = CreateWindow(TEXT("button"), TEXT(">"), WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, rc.left + 355, rc.top + 150, 25, 25, hWnd, (HMENU)IDC_BTN3UP, (HINSTANCE)GetWindowLongPtr(hWnd, GWLP_HINSTANCE), NULL);
	g_hBtn3Down = CreateWindow(TEXT("button"), TEXT("<"), WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, rc.left + 330, rc.top + 150, 25, 25, hWnd, (HMENU)IDC_BTN3DOWN, (HINSTANCE)GetWindowLongPtr(hWnd, GWLP_HINSTANCE), NULL);
